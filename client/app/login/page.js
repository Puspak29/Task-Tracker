...
import { CheckSquare, Eye, EyeOff, LogIn, AlertCircle } from 'lucide-react';
        ...
        <div className="bg-[#393E46] border border-white/5 rounded-2xl p-8 shadow-2xl shadow-black/60">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4.5" noValidate>
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="login-email" className="text-[12.5px] font-bold text-[#EEEEEE]/70 uppercase tracking-wider">
                Email
              </label>
              <input
                id="login-email"
            ...
            {/* Password */}
            <div className="flex flex-col gap-1.5">
              <label htmlFor="login-password" className="text-[12.5px] font-bold text-[#EEEEEE]/70 uppercase tracking-wider">
                Password
              </label>
